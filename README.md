...
Building **AI Data Pipelines · LLM Systems · Agentic Development**

Python 기반 **ETL · AI 데이터 파이프라인 · LLM 시스템 개발**  
폐쇄망 및 공공 프로젝트 환경에서 **AI 서비스 및 개발 인프라 구축 경험**
...
- **Claude Code 기반 AI 자동 개발 환경 구축**
- **BigQuery · Redis 데이터 아키텍처 설계**
- **폐쇄망 / 공공 프로젝트 AI 인프라 구축 경험**
...
- Claude Code 기반 **AI 자동 개발 환경**
- LLM 기반 **Knowledge System**
- **AI 개발 파이프라인 자동화**
- Closed Network AI Infrastructure
